                ...
                <div className='flex gap-3 items-center mb-1'>
                    ...
                    <div>
                        ...
                        <span className='text-ascent-2 text-sm'>
                            {moment(reply?.createdAt ?? new Date()).fromNow()}
                        </span>
                    </div>
                ...
                {errMsg?.message && (
                    ...
                    <div className='flex items-end justify-end pb-2'>
                        {loading ? (
                            ...
                            title='Submit'
                            type='submit'
                            containerStyles='bg-[#f97316] text-white py-1 px-3 rounded-full font-semibold text-sm'/>
      ...
      <div className='flex gap-3 items-center mb-2'>
        ...
        <div className='w-full flex justify-between'>
            <div className=''>
                ...
                <span className='text-ascent-2'>{post?.userId?.location ?? "No Locations"}</span>
            </div>
        ...
        <p className='text-ascent-2'>
            ...
            }
            {
                post?.description?.length > 301 && (
                    showAll === post?._id ? ( <span className='text-[#f97316] ml-2 font-medium cursor-pointer'
                    onClick={() => setShowAll(0)}> Show Less</span>
                    ) : (
                         <span className='text-[#f97316] ml-2 font-medium cursor-pointer'
      ...
      <div className='mt-4 flex justify-between items-center px-3 py-2 text-ascent-2 text-base border-t border-[#66666645]'>
        <p className='flex gap-2 items-center text-base cursor-pointer'>
            {post?.likes?.includes(user?._id) ? (
                <BiSolidLike size={20} color='#f97316'/>
            ) : (
                <BiLike size={20}/>
            )}
